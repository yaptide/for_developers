...
for path in sorted(Path("yaptide","yaptide").rglob("*.py")):
    module_path = path.relative_to("yaptide","yaptide").with_suffix("")
    doc_path = path.relative_to("yaptide","yaptide").with_suffix(".md")
...
with mkdocs_gen_files.open("docs/reference/SUMMARY.md", "w") as nav_file:
